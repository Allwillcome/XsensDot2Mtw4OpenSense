...
def transformed_Xsens_dot_data_Realtime(filename): 
       ...
       df_quat = df[["Quat_W","Quat_X","Quat_Y","Quat_Z"]]     #Select the column in which euler Angle is located 选择欧拉角所在的列

       #Make a quaternion conversion 进行四元数的转换
       r = R.from_quat(df_quat)                                #Initialize a quaternion 初始化四元数
